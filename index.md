...
venue: "Seminar Room 2, Walter and Eliza Hall Institute"        # brief name of host site without address (e.g., "Euphoric State University")
...
collaborative_notes: ["http://pad.software-carpentry.org/2018-4-26-SWC-Melbourne"]             # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document
